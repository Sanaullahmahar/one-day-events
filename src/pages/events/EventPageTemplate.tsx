...
const EventPageTemplate = ({ event }: EventPageTemplateProps) => (
    ...
    <main>
      <section className="relative overflow-hidden pb-0 pt-16">
        <Container className="relative z-10 text-center">
          ...
          <Button
            size="lg"
            className="mt-8 rounded-full bg-cta px-10 text-cta-foreground hover:bg-cta/90"
            asChild
          >
      ...
      <section className="bg-card py-16">
        <Container className="max-w-3xl">
          <h2 className="mb-8 text-[30px] font-extrabold leading-[1.1] text-foreground">
      ...
      <section className="bg-muted py-20 text-center">
        <h2 className="text-[32px] font-bold text-foreground">
          Ready to protect your {event.shortTitle.toLowerCase()}?
        </h2>
        <Button
          size="lg"
          className="mt-8 rounded-full bg-cta px-10 text-cta-foreground hover:bg-cta/90"
